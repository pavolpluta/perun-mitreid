...
<div id="footer">
    <div style="margin: 0px auto; max-width: 1000px;">
        <div style="float: left;">
            <img src="https://login.ceitec.cz/proxy/module.php/ceitec/res/img/logo_64.png">
        </div>
        <div style="float: left;">
...
<script type="text/javascript" src="https://login.ceitec.cz/proxy/resources/script.js"></script>
