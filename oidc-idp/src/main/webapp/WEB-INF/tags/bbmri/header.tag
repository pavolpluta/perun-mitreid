...
<head>
    ...
    <link rel="stylesheet" type="text/css"
          href="<c:out value='${baseUrl}'/>proxy/module.php/bbmri-eric/res/bootstrap/css/bootstrap.min.css" />
    <link rel="stylesheet" type="text/css"
          href="<c:out value='${baseUrl}'/>proxy/module.php/bbmri-eric/res/css/bbmri-eric.css" />
    <link rel="stylesheet" media="screen" type="text/css"
          href="<c:out value='${baseUrl}'/>proxy/module.php/consent/style.css" />
    <link rel="stylesheet" media="screen" type="text/css"
          href="<c:out value='${baseUrl}'/>proxy/module.php/bbmri-eric/res/css/consent.css" />
</head>
<body>
    <div id="wrap">
        <div id="header">
            <img src="<c:out value='${baseUrl}'/>proxy/module.php/bbmri-eric/res/img/BBMRI-ERIC-gateway-for-health_430.png" alt="BBMRI-ERIC logo">
