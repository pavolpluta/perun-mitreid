...
class Mapper {
	 ...
	 */
	static List<Group> mapGroups(JsonNode jsonNode) {
	 ...
	 */
	static List<Member> mapMembers(JsonNode jsonNode) {
	 ...
	 */
	static PerunAttribute mapAttribute(JsonNode jsonNode) {
	 ...
	 */
	static Map<String, PerunAttribute> mapAttributes(JsonNode jsonNode) {
	 ...
	 */
	static Vo mapVo(JsonNode jsonNode) {
		Vo vo = new Vo();
